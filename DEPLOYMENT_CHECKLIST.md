...
- [ ] All repository files uploaded to GitHub root.
...
- [ ] Individual preview and Excel downloads work.
- [ ] **Download all workbooks** ZIP works.
- [ ] Manual delete removes temporary files.
- [ ] `RUN_LOCALLY.md` is visible in the GitHub repository.
